...
public class FavoritesAdapter extends EventAdapter {
        ...
        public FavoritesAdapter (List<VEvent> events, Context context) {
            this.events = events;
        ...
        public EventViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ProfileActivity eventsListActivity = (ProfileActivity) context;
